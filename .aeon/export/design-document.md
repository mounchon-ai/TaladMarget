...
| ADR-001 | design · revised | 2026-09-23T12:43:54Z | หน้าต่างแก้ราคาสินค้า (UI-talad-013) ผูกทั้ง "ราคาปัจจุบัน" และ "ราคาใหม่" ไว้กับ ENT-002.price ทั้งที่เป็นคนละแถว — ราคาปัจจุบันคือเวอร์ชันราคาที่ใช้อยู่ ส่วนราคาใหม่คือเวอร์ชันที่จะสร้าง (DQ-talad-006: แก้ราคาต้องสร้างเวอร์ชันใหม่ทุกครั้ง) · design ตัดสินให้ "ราคาปัจจุบัน" เป็นช่องแสดงผลที่ไม่ผูก entity และ "ราคาใหม่" ยังผูก ENT-002.price เพราะเป็นค่าที่ถูกบันทึก · ที่มา: การ์ดของ mock UI-talad-013 (data-testid ซ้ำ ui-talad-013-ent-002-price) | รับเข้าแล้ว 2026-09-23T12:49:26Z |
...
| sitemap.json | /design:sitemap | done | approved | mon sai | 2026-09-23T12:49:54Z | — |
| modules/talad/screens.json | /design:sitemap | done | approved | mon sai | 2026-09-23T12:49:54Z | — |
...
| ฟิลด์ | ผูกกับข้อมูล | อ่าน/กรอก | บังคับ | กฎตรวจสอบ | กฎธุรกิจที่คุม |
|---|---|---|---|---|---|
| ราคาปัจจุบัน | ไม่ผูกกับเอนทิตีไหน | อ่าน | ไม่บังคับ | แสดงราคาของเวอร์ชันราคาที่ใช้อยู่ของสินค้า (ENT-002 แถวปัจจุบัน) อ่านอย่างเดียว — ไม่ผูกคอลัมน์ เพราะช่องราคาใหม่เป็นผู้ถือ ENT-002.price ของเวอร์ชันที่จะสร้าง (ADR-001) | — |
